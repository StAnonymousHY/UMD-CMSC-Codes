...
/* package haskell-intro-0.1.0.0 */
#ifndef VERSION_haskell_intro
#define VERSION_haskell_intro "0.1.0.0"
#endif /* VERSION_haskell_intro */
#ifndef MIN_VERSION_haskell_intro
#define MIN_VERSION_haskell_intro(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_intro */
...
#define CURRENT_COMPONENT_ID "haskell-intro-0.1.0.0-LE8q5Mr4Dn8HwPrA9myE1B-hw01"
