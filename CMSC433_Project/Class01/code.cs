// Dafny program code.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\YHXHa\Desktop\UMD-CMSC-Codes\CMSC433_Project\Class 1\code.dfy
// code.dfy
...
method Access(a: array<int>, i: int) returns (x: int)
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger Mystery(BigInteger[] a, BigInteger x)
    {
    ...
    public static BigInteger Access(BigInteger[] a, BigInteger i)
    {
      BigInteger x = BigInteger.Zero;
      if (((i).Sign != -1) && ((i) < (new BigInteger((a).Length)))) {
        x = (a)[(int)(i)];
        return x;
      }
      x = new BigInteger(-1);
